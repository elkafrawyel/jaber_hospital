...
class InstrumentsOrderWidget extends StatelessWidget {
  const InstrumentsOrderWidget({Key? key, required this.index, required this.order}) : super(key: key);
  final int index;
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: ()=> Nav.navigateTo(OrderDetailsScreen(orderModel: order, isMedication: false,), navigatorType: NavigatorType.push),
      child: Container(
        width: size.width,
