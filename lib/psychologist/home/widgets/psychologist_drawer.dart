...
class PsychologistHomeDrawer extends StatelessWidget {
  const PsychologistHomeDrawer({
    Key? key,
  }) : super(key: key);
            ...
            Expanded(
              child: ListView(
                children: [
                  ...
                  ListTile(
                    leading: Image.asset(Res.imagesPatientDrawer, scale: 2.8, color: Colors.black,
