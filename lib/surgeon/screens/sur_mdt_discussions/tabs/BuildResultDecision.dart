            ...
            itemBuilder: (context, index) =>
                InkWell(
                  onTap: () => Nav.navigateTo(
                    SurPatientDetails(
                        patientId: state.data?.patients?[index].id?? ""),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        MyText(
                                          title: (state.data?.patients?[index]
                                              .mdtResults ?? '').toCapitalized(),
                                          size: 10,
                                          color: (state.data?.patients?[index].mdtResults == "accept") ? MyColors.primary :
                                          (state.data?.patients?[index].mdtResults == "refuse")?Colors.red:
                                          Colors.green,
                                        ),
                                      ],
                                    ),
