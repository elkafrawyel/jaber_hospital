                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  child: MyText(
                                    title: DateTime.tryParse(state.data![index].mdtDateTime!) == null
                                        ? state.data![index].mdtDateTime!
                                        : DateFormat("E ,d MMM y").format(
                                            DateTime.parse(state.data![index].mdtDateTime!),
                                          ),
                                    size: 11,
                                ...
                                InkWell(
                                  onTap: () {
                                    showDialog(
                                      context: context,
                                      builder: (context) => BuildBookTimesDialog(patient: state.data![index]),
                                    );
                                  },
                                  child: MyText(
                                    title: '(Change)',
